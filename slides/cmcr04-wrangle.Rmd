...
Note that you should actually save your username and password in your [.Renviron](https://usethis.r-lib.org/reference/edit.html) as "GESIS_USER" and "GESIS_PASS" to keep your information private.

<img src="cmcr04_files/Renviron.png" style="width: 800px;"/>
...
>- [`ropercenter`: Reproducible Retrieval of Roper Center Datasets](https://cran.r-project.org/package=ropercenter).
...
>- An indispensible resource: RStudio's [Cheatsheet to Data Wrangling](https://github.com/rstudio/cheatsheets/raw/master/data-transformation.pdf). I still love [the old one](https://www.rstudio.com/wp-content/uploads/2015/02/data-wrangling-cheatsheet.pdf).
