...
---
```
The stuff you'll want to change here is pretty obvious, I think.  For now at least, definitely leave everything under `output:` alone.  For more detail on each entry, see [Steven V. Miller's post on his template](http://svmiller.com/blog/2016/02/svm-r-markdown-manuscript/).
