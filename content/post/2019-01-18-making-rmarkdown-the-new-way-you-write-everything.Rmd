...
RMarkdown is just super-great.  To start, it's plain text, so you can edit with basically anything. Next, [its formatting](https://pandoc.org/MANUAL.html#pandocs-markdown) is, at least for the most part, easy to remember and easy to interpret.  Plus, because it's <b><i>R</i></b>Markdown, it lets you mix text and R code so that all of your work is in the same document, making it easy for others ([and your future self](https://statmodeling.stat.columbia.edu/2014/12/31/closest-collaborator-cant-talk/)) to see exactly what you did and, if desired, reproduce your work.  And it's so versatile, you can use it for _all_ your writing.
...
---
```
The stuff you'll want to change here is pretty obvious, I think.  For now at least, definitely leave everything under `output:` alone.  For more detail on each entry in the YAML header, see [Steven V. Miller's post on his template](http://svmiller.com/blog/2016/02/svm-r-markdown-manuscript/).
...
Unfortunately, I don't think there's a good Bib$\TeX$ integration option for RMarkdown syllabi yet.  I want something that formats full mid-document bibliographic citations, in full APSR format, with links to download.  I really should dig more on this, but in the meantime I'm just typing them in `r emo::ji("frown")`.  [You'll find an example repo here](https://github.com/cmcr-class/example_syllabus) and [the RMarkdown syllabus for *this course* is here](https://github.com/cmcr-class/cmcr-class.rbind.io/blob/master/syllabus/7450CMCR_Syl.Rmd).
